    ...
    <div className="w-full lg:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lg:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          {/* Add actual links for social media profiles */}
          <a href="#" className="bannerIcon"><FaFacebookF /></a>
          <a href="#" className="bannerIcon"><FaTwitter /></a>
          <a href="#" className="bannerIcon"><FaLinkedinIn /></a>
        </div>
      </div>
    </div>
  );
